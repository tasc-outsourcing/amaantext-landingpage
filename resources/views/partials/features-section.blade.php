<section id="features" class="py-28 px-8 lg:px-16 bg-white">
    <div class="container mx-auto max-w-6xl">
        ...
        <div class="relative max-w-5xl mx-auto">
            <div class="relative rounded-[30px] overflow-hidden shadow-2xl border-4 border-[#005f83]/20">
            ...
            <div class="absolute -top-4 -left-4 w-20 h-20 bg-[#ffe102] rounded-full blur-2xl opacity-30"></div>
            <div class="absolute -bottom-4 -right-4 w-20 h-20 bg-[#00bfff] rounded-full blur-2xl opacity-30"></div>
        </div>
    </div>
</section>
